...
_show(candidate.select("CNSL_ID", "CNSL_TYPE_CD", "CNSL_CHNL_CD", "CNSL_ST_CD", "STRT_DTM", "END_DTM",
                       "_unmapped_codes", "_map_errors"), 10)
...
for code_col in ("CNSL_TYPE_CD", "CNSL_ST_CD", "CNSL_CHNL_CD"):
